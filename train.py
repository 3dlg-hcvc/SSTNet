...
def eval(model, cfg, tb_writer, logger, epoch):
    ...
    val_dataset = gorilla.build_dataset({**cfg.dataset, "use_normals": cfg.model.use_normals,
                                         "ignore_label": cfg.data.ignore_label, "filename_suffix": cfg.data.filename_suffix})
